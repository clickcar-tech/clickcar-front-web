            ...
            >
              ...
              <div className='flex flex-col mt-[40px] justify-center items-center'>
                ...
                <div className='flex pt-11 items-center'>
                  ...
                  <div className='ml-40'>
                    <Button
                      className={`bg-gradient-to-r from-[#FFBF00] to-[#FFA500] w-44 h-9 border-1 rounded-3xl justify-center text-2xl font-bold shadow-2xl shadow-black ml-32 transition-transform duration-200 hover:brightness-75
